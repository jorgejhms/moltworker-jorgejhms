...
- Z.AI API key (default provider), or Anthropic API key, or AI Gateway's [Unified Billing](https://developers.cloudflare.com/ai-gateway/features/unified-billing/)
...
# Set your API key (direct Z.AI access)
...
| `ZAI_API_KEY` | Yes* | Direct Z.AI API key (default provider) |
| `ANTHROPIC_API_KEY` | No | Direct Anthropic API key (optional fallback) |
